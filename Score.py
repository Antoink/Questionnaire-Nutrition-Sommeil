...
with st.form("questionnaire_form"):
    ...
    s1 = ask_q("Durée moyenne", "Sleep duration", "1. Quelle est ta durée moyenne de sommeil ?", "1. How many hours do you sleep on average?", ["≥ 8 h", "6h–7h59", "< 6 h"], ["≥ 8 h", "6h–7h59", "< 6 h"], "s1")
