...
st.markdown("""
    ...
    /* Centrage du conteneur global des radios */
    .stRadio > div {
    ...
    /* Style de la boîte grise entourant les choix */
    div[data-testid="stRadio"] > div {
        ...
        width: 100%;
        max-width: 400px; /* Evite que ce soit trop large sur ordi */
        margin: auto;
        text-align: center;
    }
    
    /* Centrage forcé de l'élément interne (bouton + texte) */
...
if st.button("Sauvegarder / Save", use_container_width=True, key="save_btn"):
